...
class VideoScoutTrainingsScene extends StatefulWidget {
  VideoScoutTrainingsScene({Key key}) : super(key: key);

  @override
  _VideoScoutTrainingsSceneState createState() => _VideoScoutTrainingsSceneState();
}

enum TrainingAction { clone, delete }

class _VideoScoutTrainingsSceneState extends State<VideoScoutTrainingsScene> {
  ...
  @override
  void initState() {
    trainings = TrainingProvider.getVideoTrainings();
    super.initState();
  }
  ...
  void _showReport(Training t) async {
    await Navigator.pushNamed(context, '/video_scout/report', arguments: t);
    _refresh();
  }
